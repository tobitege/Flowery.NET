...
- Fixed the Android gallery deployment script and documentation to use the current .NET 10 Android target framework.

## [2.0.4] - 2026-05-09

### Fixed

- Fixed custom border and content font handling for `DaisyRadio`, `DaisyCheckBox`, `DaisyToggle`, and `DaisyTagPicker`.

## [2.0.3] - 2026-05-07

### Fixed

- Fixed custom border brush and thickness handling for `DaisyRadio`, `DaisyCheckBox`, `DaisyToggle`, and `DaisyTagPicker`.

## [2.0.2] - 2026-05-07

### Changed

- Bumped stable NuGet package patches for Avalonia 12, `System.Text.Json`, and test tooling.
